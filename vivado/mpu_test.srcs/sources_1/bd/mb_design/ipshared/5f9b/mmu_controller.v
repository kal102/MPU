...
(
  ...
  reg shift_gen, shift_nxt, shift_last;
  reg clear_nxt;
  ...
  always @(posedge clk) begin
    if (!rst_n) begin
      ...
      buffer_a_cmd <= (buffer_ab_stop) ? buffer_a_cmd : buffer_a_cmd_nxt;
      buffer_b_cmd <= (buffer_ab_stop) ? buffer_b_cmd : buffer_b_cmd_nxt;
  ...
  always @* begin
    ...
    case (state)
      ...
      STATE_WAIT: begin
        ...
        else if (shift_last && !shift) begin
